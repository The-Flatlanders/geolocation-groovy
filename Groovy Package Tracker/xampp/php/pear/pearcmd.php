...
if ('C:\Users\amind_000\Desktop\IDT Contest\Git\geolocation-groovy\Groovy Package Tracker\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\amind_000\Desktop\IDT Contest\Git\geolocation-groovy\Groovy Package Tracker\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
